...
def sample_medmcqa(combination_name, device, random_value):
    if len(combination_name) == 1:
        student_train_knowledge_saved_path="/home/datasets/MedMCQA/knowledge2/student_train/teacher_{}.jsonl".format(combination_name)
    else:
        student_train_knowledge_saved_path="/home/datasets/MedMCQA/knowledge2_kldiv4.0/student_train/teacher_{}.jsonl".format(combination_name)
...
if __name__ == "__main__":
    ...
    rep_path = "/home/datasets/MedMCQA/knowledge2_kldiv4.0/combination_representations.tsv"
    acc_path = "/home/datasets/MedMCQA/knowledge2_kldiv4.0/combination_accuracy.tsv"
    ...
    # init with 14 singular teacher combinations
