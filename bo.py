...
def sample(combination_name, device, random_value):
    ...
    if len(combination_name) == 1:
        pqau_saved_path="/home/datasets/PubMedQA/knowledge2/pqau/teacher_{}.jsonl".format(combination_name)
        pqal_dev_saved_path="/home/datasets/PubMedQA/knowledge2/pqal_dev/teacher_{}.jsonl".format(combination_name)
    else:
        pqau_saved_path="/home/datasets/PubMedQA/knowledge2_kldiv4.0/pqau/teacher_{}.jsonl".format(combination_name)
        pqal_dev_saved_path="/home/datasets/PubMedQA/knowledge2_kldiv4.0/pqal_dev/teacher_{}.jsonl".format(combination_name)
...
if __name__ == "__main__":
    ...
    rep_path = "/home/datasets/PubMedQA/knowledge2_kldiv4.0/avg_combination_representations.tsv"
    acc_path = "/home/datasets/PubMedQA/knowledge2_kldiv4.0/avg_combination_accuracy.tsv"
    ...
    # init with 10 singular teacher combinations
